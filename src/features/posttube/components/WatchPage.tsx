  ...
  return (
    <Link href={`/posttube/watch/${video.id}`} className="group flex gap-2">
      <div className="relative w-[168px] shrink-0 overflow-hidden rounded-lg bg-brand-secondary aspect-video">
        {video.thumbnail_url ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-slate-200 to-slate-100">
            <svg className="h-6 w-6 text-brand-text/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="min-w-0 flex-1 py-0.5">
        <h4 className="line-clamp-2 text-[13px] font-semibold leading-tight text-brand-text group-hover:text-brand-text">
          {video.title}
        </h4>
        ...
        <div className="h-full min-h-0 overflow-y-auto">
          <div className="mx-auto max-w-[1280px] px-6 py-4">
            ...
            <div className="mt-4 space-y-3">
              <div className="h-6 w-3/4 animate-pulse rounded bg-brand-secondary" />
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 animate-pulse rounded-full bg-brand-secondary" />
                <div className="space-y-1.5">
                  <div className="h-4 w-32 animate-pulse rounded bg-brand-secondary" />
                  <div className="h-3 w-20 animate-pulse rounded bg-brand-secondary" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto flex max-w-[1280px] gap-6 px-6 py-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2 flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                className={`shrink-0 rounded-full px-4 py-2 text-[13px] font-bold transition-colors ${
                  subscribed
                    ...
                    : "bg-slate-900 text-white hover:bg-brand-text"
                }`}
              >
              ...
              <div className="flex items-center rounded-full bg-brand-secondary overflow-hidden">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-2 text-[13px] font-semibold border-r border-brand-divider transition-colors ${
                    liked ? "bg-brand-secondary" : "hover:bg-brand-secondary"
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center px-3 py-2 transition-colors ${
                    disliked ? "bg-brand-secondary" : "hover:bg-brand-secondary"
                  }`}
                >
              ...
              <button
                type="button"
                className="flex items-center gap-1.5 rounded-full bg-brand-secondary px-4 py-2 text-[13px] font-semibold text-brand-text hover:bg-brand-secondary transition-colors"
              >
              ...
              <button
                ...
                className={`flex items-center gap-1.5 rounded-full px-4 py-2 text-[13px] font-semibold transition-colors ${
                  saved ? "bg-brand-secondary text-brand-text" : "bg-brand-secondary text-brand-text hover:bg-brand-secondary"
                }`}
              >
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-secondary text-brand-text hover:bg-brand-secondary transition-colors"
              >
            ...
            <div
              className="mt-3 rounded-xl bg-brand-secondary px-4 py-3 cursor-pointer hover:bg-brand-secondary/70 transition-colors"
            ...
            >
              ...
              {video.description && (
                <p className="mt-1.5 whitespace-pre-line text-[13px] leading-relaxed text-brand-text">
                  {displayDesc}
                </p>
              )}
              {isLongDesc && (
                <button
                  ...
                  className="mt-1 flex items-center gap-1 text-[13px] font-semibold text-brand-highlight hover:text-brand-text transition-colors"
                >
                  {descExpanded ? (
            ...
            {commentsOpen && (
              <div className="mt-4 mb-8">
                <div className="flex items-center gap-6 mb-4">
                  ...
                  <button type="button" className="flex items-center gap-1.5 text-[13px] font-semibold text-brand-highlight hover:text-brand-text transition-colors">
