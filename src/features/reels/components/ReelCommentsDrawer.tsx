      ...
      {open ? (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-x-0 bottom-0 z-40 flex h-[72vh] flex-col rounded-t-2xl border border-border bg-brand-card text-brand-text shadow-2xl md:static md:h-full md:w-[min(520px,38vw)] md:shrink-0 md:rounded-2xl md:shadow-none"
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
              <CommentSection postId={reel.id} postAuthorId={reel.authorId} commentsCount={reel.commentCount} alwaysExpanded focusCommentId={focusCommentId} />
            </div>
          </motion.aside>
        </>
      ) : null}
