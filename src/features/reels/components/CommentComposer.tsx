  ...
  return (
    ...
    >
      <input
        ...
        className="h-[42px] flex-1 rounded-full bg-brand-secondary px-4 text-[13px] text-brand-text placeholder:text-brand-text/60 outline-hidden transition-all focus:bg-brand-card focus:ring-1 focus:ring-brand-divider focus:shadow-[0_0_0_2px_rgba(0,0,0,0.04)]"
      />
      <button
        type="submit"
        ...
        className={`flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-full transition-all duration-200 ${
          hasValue && !pending
            ? "bg-brand-text text-brand-bg shadow-xs hover:opacity-90"
