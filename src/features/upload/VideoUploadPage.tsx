        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          {file && !published && (
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-primary-ink px-6 py-2.5 text-[13px] font-semibold text-white shadow-xs hover:bg-primary-ink disabled:opacity-40 transition-all"
            >
          ...
          {published ? (
            <motion.div key="done" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center py-20 text-center">
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button type="button" onClick={reset} className="rounded-xl bg-primary-ink px-5 py-2.5 text-[13px] font-semibold text-white hover:bg-primary-ink">Upload Another</button>
              </div>
            </motion.div>
                  ...
                  {previewUrl && !isPodcast && (
                    <div className="mt-3 rounded-xl bg-brand-secondary p-3">
                      ...
                      <button
                        ...
                        className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-lg bg-primary-ink px-3 py-2 text-[11px] font-semibold text-white hover:bg-primary-ink disabled:opacity-40 transition-all"
                      >
