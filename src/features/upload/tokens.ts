...
export const CONTENT_TYPE_META: Record<ContentType, { label: string; platformLabel: string; icon: string; aspect: string; maxDuration: number; maxSize: number }> = {
  reel:    { label: "Reel",          platformLabel: "Postgram Flicks", icon: "sparkles", aspect: "9/16", maxDuration: 180,   maxSize: 500 * 1024 * 1024 },
  short:   { label: "Flick / Clip",  platformLabel: "Posttube Shorts", icon: "clapperboard", aspect: "9/16", maxDuration: 180,   maxSize: 500 * 1024 * 1024 },
