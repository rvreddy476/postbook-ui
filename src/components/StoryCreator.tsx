                    ...
                    >
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <textarea
                                ...
                                maxLength={500}
                                rows={2}
                                className="w-full text-sm border border-brand-divider rounded-xl px-4 py-2.5 focus:outline-hidden focus:ring-2 focus:ring-blue-200 resize-none"
                            />
                            ...
                            <label className="flex items-center gap-3 text-sm text-brand-text/80 cursor-pointer">
                                <input
                                    ...
                                    className="rounded-sm border-brand-text/30 text-blue-600 focus:ring-blue-200"
                                />
                                Save as Highlight
                            </label>
                            {isHighlight && (
                                <input
                                    ...
                                    className="w-full text-sm border border-brand-divider rounded-lg px-3 py-2 focus:outline-hidden focus:ring-2 focus:ring-blue-200"
                                />
                            )}
                        </div>
                        ...
                        <div className="px-5 py-4 border-t border-brand-divider flex justify-end gap-3">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-linear-to-r from-blue-500 to-blue-600 text-white text-sm font-medium rounded-lg hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                            >
