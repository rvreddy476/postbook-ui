...
export function EndorsementSection({ userId, endorsementSummary, isOwn }: EndorsementSectionProps) {
    ...
    return (
        <div className="bg-brand-card rounded-2xl border border-[#F0E6DC] shadow-xs p-4">
            ...
            {showEndorseForm && (
                <div className="mb-4 p-3 bg-[#FAF5F0] rounded-xl border border-[#F0E6DC]">
                    <input
                        ...
                        className="w-full px-3 py-2 text-sm border border-[#F0E6DC] rounded-lg bg-brand-card text-[#3C2415] placeholder:text-[#7B5B3A]/40 focus:outline-hidden focus:ring-2 focus:ring-[#D4A574]/50 mb-2"
                    />
                    <textarea
                        value={message}
                        ...
                        rows={2}
                        className="w-full px-3 py-2 text-sm border border-[#F0E6DC] rounded-lg bg-brand-card text-[#3C2415] placeholder:text-[#7B5B3A]/40 focus:outline-hidden focus:ring-2 focus:ring-[#D4A574]/50 resize-none mb-2"
                    />
