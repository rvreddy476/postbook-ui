            ...
            <div className="space-y-3">
                ...
                {profile.profession && (
                    <div className="flex items-center gap-2.5 text-sm text-brand-highlight">
                        <Briefcase className="h-4 w-4 text-brand-text/60 shrink-0" />
                ...
                {profile.location && (
                    <div className="flex items-center gap-2.5 text-sm text-brand-highlight">
                        <MapPin className="h-4 w-4 text-brand-text/60 shrink-0" />
                        <span>{profile.location}</span>
                    </div>
                )}

                <div className="flex items-center gap-2.5 text-sm text-brand-highlight">
                    <Calendar className="h-4 w-4 text-brand-text/60 shrink-0" />
                    <span>Joined {joinedDate}</span>
                </div>

                {profile.website && (
                    <div className="flex items-center gap-2.5 text-sm text-brand-highlight">
                        <Globe className="h-4 w-4 text-brand-text/60 shrink-0" />
                        <a
