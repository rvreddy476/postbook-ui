        ...
        >
            ...
            <div className="relative h-48 sm:h-64 rounded-b-3xl overflow-hidden">
                {coverUrl ? (
                    ...
                    <div className="w-full h-full bg-linear-to-br from-brand-text/50 via-brand-text to-indigo-700" />
                )}
            ...
            <div className="relative max-w-2xl mx-auto px-4 sm:px-6">
                ...
                >
                    <div className="bg-brand-card rounded-2xl shadow-xs border border-brand-divider p-8 sm:p-10 text-center">
                        ...
                        <div className="mt-6 flex items-center justify-center gap-3">
                            <button
                                onClick={onAddFriend}
                                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary-ink text-white text-sm font-medium hover:bg-primary-ink transition-colors focus:outline-hidden focus:ring-2 focus:ring-brand-text/50 focus:ring-offset-2"
                            >
