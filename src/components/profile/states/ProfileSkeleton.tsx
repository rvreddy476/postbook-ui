...
export function ProfileSkeleton() {
    return (
        <div className="max-w-6xl mx-auto pb-12">
            ...
            <div className="rounded-b-3xl bg-brand-secondary/40 animate-pulse" style={{ aspectRatio: "3/1" }} />
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-6 -mt-16 sm:-mt-20">
                    ...
                    <div className="h-32 w-32 sm:h-36 sm:w-36 rounded-3xl bg-brand-card p-1 shadow-lg">
                        <div className="w-full h-full rounded-[20px] bg-brand-secondary/50 animate-pulse" />
                    </div>

                    {/* Name + meta */}
                    <div className="flex-1 space-y-3 pb-2 w-full">
                        <div className="flex justify-center sm:justify-start">
                            <div className="h-8 w-52 rounded-lg bg-brand-secondary/50 animate-pulse" />
                        </div>
                        <div className="flex justify-center sm:justify-start">
                            <div className="h-4 w-28 rounded-md bg-brand-secondary/50 animate-pulse" />
                        </div>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-4">
                <div className="flex gap-1 py-2">
                    {[72, 64, 56, 88, 64, 56].map((w, i) => (
                        <div
                            key={i}
                            className="h-10 rounded-xl bg-brand-secondary/40 animate-pulse"
                            style={{ width: `${w}px` }}
                        />
                    ))}
                </div>
