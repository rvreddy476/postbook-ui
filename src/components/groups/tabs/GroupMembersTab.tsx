...
const roleConfig: Record<string, { label: string; icon: React.ReactNode; color: string; bgColor: string }> = {
  owner: { label: 'Owner', icon: <Crown className="w-3 h-3" />, color: 'text-warning', bgColor: 'bg-brand-secondary border-brand-divider' },
  admin: { label: 'Admin', icon: <ShieldCheck className="w-3 h-3" />, color: 'text-brand-highlight', bgColor: 'bg-brand-secondary border-brand-divider' },
  moderator: { label: 'Mod', icon: <Wrench className="w-3 h-3" />, color: 'text-brand-text/70', bgColor: 'bg-brand-secondary border-brand-divider' },
  member: { label: 'Member', icon: <Shield className="w-3 h-3" />, color: 'text-brand-text/55', bgColor: 'bg-brand-secondary border-brand-divider' },
}
            ...
            <>
              ...
              <div className="absolute right-0 top-full mt-1 w-40 bg-brand-card border border-brand-divider rounded-xl shadow-lg py-1 z-20">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-danger hover:bg-danger/10 transition-colors"
                >
