    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-brand-divider shrink-0">
          <h2 className="text-lg font-bold text-brand-text">Create Group</h2>
          ...
          <div>
            ...
            <div className="space-y-2">
              {privacyOptions.map((opt) => (
                ...
                >
                  <div className={`${privacyLevel === opt.value ? 'text-brand-text' : 'text-brand-text/60'}`}>
                    {opt.icon}
                  </div>
                  <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {joinModeOptions.filter(o => o.value !== 'invite_only').map((opt) => (
                  ...
                  >
                    <div className={`${joinMode === opt.value ? 'text-brand-text' : 'text-brand-text/60'}`}>
                      {opt.icon}
                    </div>
                    <span className="text-xs font-semibold text-brand-text">{opt.label}</span>
                  </button>
                ))}
              </div>
            </div>
