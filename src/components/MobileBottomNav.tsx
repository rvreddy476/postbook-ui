      ...
      <ul className="grid grid-cols-6 gap-1">
        ...
        <li>
          ...
          >
            ...
            <span className="truncate text-[9px] font-black tracking-wide">Home</span>
          </button>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span className="truncate text-[9px] font-black tracking-wide">Reels</span>
          </button>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span className="truncate text-[9px] font-black tracking-wide">Messenger</span>
          </button>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span className="truncate text-[9px] font-black tracking-wide">Profile</span>
          </button>
        </li>
      </ul>
    </nav>
