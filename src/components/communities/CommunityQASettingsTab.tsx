    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 rounded-xl border border-brand-divider bg-brand-card dark:bg-brand-bg text-sm text-brand-text focus:outline-hidden focus:border-brand-text/40"
        />
      </div>
