  ...
  return (
    <div className="animate-fadeIn">
      <div className="flex items-center gap-4 mb-8">
        <div className="w-12 h-12 bg-brand-text text-white rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <h2 className="text-3xl font-black text-brand-text tracking-tighter uppercase italic">atpost TV</h2>
      </div>
