...
const Profile: React.FC<ProfileProps> = ({ user, onUpdate }) => {
  ...
  if (isEditing) {
    return (
      <div className="min-h-screen bg-brand-bg p-6 sm:p-12 animate-fadeIn">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-brand-card/70 backdrop-blur-3xl rounded-[3rem] shadow-xl border border-white/60 p-10 space-y-8">
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start mb-16">
        <div className="relative group">
          ...
          <button
            ...
            className="absolute -bottom-4 -right-4 bg-brand-card border border-brand-divider p-4 rounded-3xl shadow-2xl hover:scale-110 transition-transform text-blue-600"
          >
