...
function StatCardSkeleton() {
    return (
        <div className="bg-brand-card rounded-2xl border border-border p-5 shadow-xs animate-pulse">
            <div className="h-2.5 bg-secondary rounded-full w-20 mb-3" />
            <div className="h-6 bg-secondary rounded-full w-24 mb-2" />
...
const AnalyticsOverview: React.FC<AnalyticsOverviewProps> = ({ overview, trend, isLoading }) => {
    ...
    const stats = [
        ...
        },
        {
            ...
            sparkColor: "#7B5B3A",
            icon: (
                <svg className="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            icon: (
                <svg className="w-4 h-4 text-foreground" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {stats.map((stat) => (
                <div
                    key={stat.label}
                    className="bg-brand-card rounded-2xl border border-border p-5 shadow-xs hover:shadow-md hover:border-primary-outline transition-all duration-300"
                >
