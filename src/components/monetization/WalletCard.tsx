...
function WalletCardSkeleton() {
    return (
        <div className="bg-brand-card rounded-2xl border border-[#F0E6DC] p-6 shadow-xs animate-pulse">
...
const WalletCard: React.FC<WalletCardProps> = ({ wallet, isLoading }) => {
    ...
    return (
        <div className="bg-brand-card rounded-2xl border border-[#F0E6DC] p-6 shadow-xs hover:shadow-md transition-shadow duration-300 relative overflow-hidden">
            {/* Decorative accent */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-[#D4A574] via-[#7B5B3A] to-[#D4A574]" />
