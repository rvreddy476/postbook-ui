...
function getGradient(userId: string): { bg: string; ring: string } {
    ...
    const gradients = [
        { bg: 'from-violet-500 via-fuchsia-500 to-pink-400', ring: 'ring-violet-200' },
        ...
        >
            ...
            <div className="flex flex-col items-center -mt-10 px-4 pb-5">
                ...
                <Link href={profileHref} className="block mt-3 text-center">
                    <p className="text-sm font-bold text-slate-800 truncate max-w-[160px] hover:text-violet-600 transition-colors">
                        {displayName}
                    </p>
                    {username && (
                    ...
                    <div className="relative flex items-center gap-1 mt-1.5">
                        ...
                        {reasonCodes && reasonCodes.length > 0 && (
                            <button
                                ...
                                className="flex-shrink-0 text-slate-300 hover:text-violet-400 transition-colors"
