...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: 'List your catalog and reach millions of users on AtPost.',
  },
]
    ...
    <div className="min-h-screen bg-[#F5F0EB] font-sans">
      ...
      <header className="sticky top-0 z-50 bg-[#F5F0EB]/90 backdrop-blur-md border-b border-[#E8DDD3]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-[#1A1A1A] text-sm leading-none">AtPost Commerce</p>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-24">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-[#E8DDD3] rounded-full text-sm text-[#4A3728] mb-8 shadow-sm">
          ...
          Sell products. Build your brand. Grow on AtPost.
        </div>
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-[#6B5544] mb-10">Join thousands of sellers growing their business on AtPost.</p>
          <Link
            href={startHref}
