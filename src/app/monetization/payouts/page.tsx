...
function PayoutMethodCard({ method, onRemove, isRemoving }: PayoutMethodCardProps) {
    return (
        <div className="flex items-center gap-4 px-4 py-3 rounded-xl bg-background border border-border hover:border-primary-outline/50 transition-all duration-200">
            <div className="w-9 h-9 rounded-lg bg-brand-card border border-border flex items-center justify-center shrink-0">
                <svg className="w-4 h-4 text-primary-ink" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] font-bold text-muted-foreground truncate">{methodSummary(method)}</p>
            </div>
            <button
...
function RequestPayoutForm({ balance, currency, methods, onSubmit, onCancel, isPending }: RequestPayoutFormProps) {
    ...
    const inputClass =
        "w-full px-4 py-3 rounded-xl border border-border bg-background text-sm font-bold text-foreground placeholder:text-primary-ink/60 focus:outline-hidden focus:ring-2 focus:ring-primary/30 focus:border-primary-outline transition-all duration-200"

    return (
        <div className="bg-brand-card rounded-2xl border border-primary-outline p-6 shadow-md shadow-[#D4A574]/10">
            <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-primary to-primary-ink flex items-center justify-center">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                </div>
                <div>
                    <h3 className="text-sm font-black text-foreground">Request Payout</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm font-black text-primary-ink">{sym}</span>
                        <input
                            type="number"
                            step="0.01"
                            min="0.01"
...
function TaxInfoForm({ onSubmit, isPending }: TaxInfoFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-brand-card rounded-2xl border border-border p-6 shadow-xs">
            <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-primary-ink to-primary-hover flex items-center justify-center shadow-lg shadow-[#7B5B3A]/20">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
            ...
            <div className="max-w-3xl mx-auto px-4 pt-10 pb-16">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-1">
                        <div className="w-10 h-10 rounded-[0.8rem] bg-linear-to-br from-primary to-primary-ink flex items-center justify-center shadow-lg shadow-[#D4A574]/20">
                            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                        </div>
...
{/* Balance summary + request payout button */}
                <div className="bg-brand-card rounded-2xl border border-border p-5 shadow-xs mb-6">
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xs font-black text-foreground">Payout Methods</h2>
                        {!showAddMethod && (
                            <button
                    ...
                    {methodsLoading ? (
                        <div className="space-y-2">
                            {[1, 2].map((i) => (
                                <div key={i} className="flex items-center gap-4 px-4 py-3 rounded-xl bg-background border border-border animate-pulse">
                        ...
                        <div className="flex flex-col items-center py-8 gap-3">
                            <div className="w-10 h-10 rounded-xl bg-background border border-border flex items-center justify-center">
                                <svg className="w-5 h-5 text-primary-ink" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                {/* Payout History */}
                <div>
                    <h2 className="text-xs font-black text-foreground mb-4">Payout History</h2>
                    <TransactionTable
