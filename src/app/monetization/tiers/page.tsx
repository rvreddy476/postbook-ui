        ...
        <form onSubmit={handleSubmit} className="bg-brand-card rounded-2xl border border-border p-6 shadow-xs">
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    />
                    <p className="text-[8px] font-bold text-primary-ink mt-1">
...
function TierCardSkeleton() {
    return (
        <div className="bg-brand-card rounded-2xl border border-border overflow-hidden shadow-xs animate-pulse">
        ...
        <div className="min-h-screen bg-background">
            <div className="max-w-3xl mx-auto px-4 pt-10 pb-16">
                ...
                {!isLoading && !isError && allTiers.length === 0 && !showForm && (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                        <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-primary to-primary-ink flex items-center justify-center shadow-lg shadow-[#D4A574]/20 opacity-40">
