            ...
            <div className="max-w-4xl mx-auto px-4 pt-10 pb-16">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <h1 className="text-2xl font-black tracking-tight text-foreground">Content Analytics</h1>
                    </div>
                ...
                <div className="flex items-center gap-2 mb-6">
                    <div className="flex items-center gap-2 mr-3">
                        ...
                        <span className="text-[9px] font-black tracking-widest text-muted-foreground">Period</span>
                    </div>
                    {PERIODS.map((p) => (
                        <button
                            key={p.value}
                ...
                {isError ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground mt-0.5">Failed to load analytics data. Please try again later.</p>
                        </div>
                    </div>
                ) : (
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-black text-foreground">Performance Overview</h3>
                                    <p className="text-[9px] font-bold text-muted-foreground tracking-widest">Key metrics at a glance</p>
                                </div>
                            </div>
                            <AnalyticsOverview
                                overview={overview}
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-black text-foreground">Content Performance</h3>
                                    <p className="text-[9px] font-bold text-muted-foreground tracking-widest">Click a row to see detailed analytics</p>
                                </div>
                            </div>
