        ...
        <div className="group bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md hover:border-[#D8103F]/10 transition-all duration-300">
            <div className="flex items-start gap-4">
                ...
                <button
                    ...
                    disabled={isPending}
                    className="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest border border-slate-200 text-slate-500 bg-white hover:border-rose-200 hover:bg-rose-50 hover:text-rose-500 active:scale-95 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[10px] font-bold text-slate-400 mt-0.5">Failed to load your saved items.</p>
                        </div>
                    </div>
                ) : allItems.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
