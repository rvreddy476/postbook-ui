  ...
  return (
    <AppShell activeTab="Memories">
      <div className="mx-auto max-w-[1180px] px-6 pt-6">
        <div className="flex flex-col gap-4 rounded-[28px] border border-brand-divider bg-[#FFF9EE] px-6 py-5 shadow-xs md:flex-row md:items-center md:justify-between">
          <div>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-2xl border border-[#E9C98C] bg-white px-5 py-3 text-[11px] font-black uppercase tracking-[0.18em] text-warning transition-colors hover:bg-[#FFF2D6]"
          >
            Open On This Day
          </Link>
        </div>
